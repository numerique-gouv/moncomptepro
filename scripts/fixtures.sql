...
VALUES
  ...
  (3,
   ...
   'oauth_api_gouv_client_secret',
    '{"http://particulier.api.localtest.me:3000/auth/api_gouv/callback", "http://entreprise.api.localtest.me:3000/auth/api_gouv/callback", "http://localhost:3000/auth/api_gouv/callback", "https://sandbox.dashboard.entreprise.api.gouv.fr/auth/api_gouv/callback", "https://sandbox1.entreprise.api.gouv.fr/auth/api_gouv/callback", "https://sandbox2.entreprise.api.gouv.fr/auth/api_gouv/callback"}',
    '{"http://particulier.api.localtest.me:3000", "http://entreprise.api.localtest.me:3000", "http://localhost:3000", "https://sandbox.dashboard.entreprise.api.gouv.fr/", "https://sandbox1.entreprise.api.gouv.fr/", "https://sandbox2.entreprise.api.gouv.fr/"}',
   'openid email')
ON CONFLICT (id)
  DO UPDATE
