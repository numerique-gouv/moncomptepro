...
VALUES
  (1,
   ...
   '{"http://localhost:3000", "http://localhost:3001", "https://datapass-development.api.gouv.fr", "https://datapass-gouv-fr.herokuapp.com"}',
  ...
  (3,
   ...
   '{"http://localhost:3000/auth/api_gouv/callback", "https://sandbox.dashboard.entreprise.api.gouv.fr/auth/api_gouv/callback", "https://sandbox1.entreprise.api.gouv.fr/auth/api_gouv/callback", "https://sandbox2.entreprise.api.gouv.fr/auth/api_gouv/callback", "https://sandbox.entreprise.api.gouv.fr/auth/api_gouv/callback"}',
   '{"http://localhost:3000", "https://sandbox.dashboard.entreprise.api.gouv.fr/", "https://sandbox1.entreprise.api.gouv.fr/", "https://sandbox2.entreprise.api.gouv.fr/", "https://sandbox.entreprise.api.gouv.fr/"}',
   'openid email')
ON CONFLICT (id)
  DO UPDATE
