...
VALUES
  (1, 1, 'darkangels.world', 'trackdechets_postal_mail', CURRENT_TIMESTAMP),
  (2, 2, 'darkangels.world', 'trackdechets_postal_mail', CURRENT_TIMESTAMP),
  (3, 3, 'darkangels.world', 'trackdechets_postal_mail', CURRENT_TIMESTAMP);
