...
describe("sign-in with a client requiring consistency-checked identity", () => {
  beforeEach(() => {
    ...
    cy.setRequestedAcrs(["urn:dinum:ac:classes:consistency-checked"]);
  });
...
describe("sign-in with a client requiring consistency-checked and consistency-checked-2fa identity", () => {
  beforeEach(() => {
    cy.visit("http://localhost:4000");
    cy.setRequestedAcrs([
  ...
  it("should return an error with ial1", function () {
    ...
    cy.mfaLogin("ial1-aal2@yopmail.com");
